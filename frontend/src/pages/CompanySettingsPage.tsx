...
const PLANS: {
  ...
  },
  {
    ...
    limit: '2,000 AI requests / month',
    features: [
      'Up to 2,000 AI requests per month',
  ...
  },
  {
    ...
    priceNote: '/ month',
    icon: <Rocket size={16} />,
    color: 'border-amber-600 hover:border-amber-400',
...
function PlanBadge({ plan }: { plan: Plan }) {
  ...
  return (
      <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold ${p.badgeColor}`}>
      {p.icon}
        {p.label}
    </span>
  )
              ...
              {PLANS.map((plan) => {
                ...
                return (
                    ...
                    >
                      ...
                      <p className="text-xs text-gray-400 mb-3">{plan.limit}</p>
