...
from app.api import projects, tasks, actors, teams, github, companies, auth, skills, agents, ai_logs, memory
...
app.include_router(memory.router, prefix="/projects", tags=["memory"])
