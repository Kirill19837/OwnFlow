    ...
    return [
        {
            ...
            "content": (
                ...
                "  If 'output_format' is not yet captured, ask it FIRST as the highest priority.\n"
                "  Example: 'How would you like to receive the output? Should it be code files in a PR,\n"
                "  a Figma design file, a markdown document in the repo, or something else?'\n"
                "  After the JSON blocks, list every remaining question as a numbered list. "
